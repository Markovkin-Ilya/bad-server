...
export const getCustomers = async (
    ...
    try {
        ...
        const realLimit = Math.min(Number(limit) || 10, 10)
        ...
        const options = {
            sort,
            skip: (Number(page) - 1) * Number(realLimit),
        ...
        const totalPages = Math.ceil(totalUsers / Number(realLimit))
